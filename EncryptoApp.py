...
3. Click ENCRYPT Button to encrypt. A new encrypted file with ".Encrypto" extention e.g. "abc.jpg.Encrypto" will be created in the same directory where the "abc.jpg" is.
4. When you want to Decrypt a file you, will select the file with the ".Encrypto" extention and Enter your Secret Key which you chose at the time of Encryption. Click DECRYPT Button to decrypt. The decrypted file will be of the same name as before with the suffix "__deEncryptoted__" e.g. "abc__deEncryptoted__.jpg".
